...
src_install() {
	...
	make_desktop_entry kvis Kvis "${FILESDIR}"/karma-icon.png "Astronomy;Science"
	make_desktop_entry kpvslice Kpvslice "${FILESDIR}"/karma-icon.png "Astronomy;Science"
	make_desktop_entry kshell Kshell "${FILESDIR}"/karma-icon.png "Astronomy;Science"
	make_desktop_entry xray Xray "${FILESDIR}"/karma-icon.png "Astronomy;Science"
	make_desktop_entry koords Koords "${FILESDIR}"/karma-icon.png "Astronomy;Science"
}
