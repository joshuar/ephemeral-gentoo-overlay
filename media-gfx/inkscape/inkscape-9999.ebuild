...
inherit gnome2 eutils subversion autotools

DESCRIPTION="A SVG based generic vector-drawing program"
HOMEPAGE="http://www.inkscape.org/"
ESVN_REPO_URI="http://inkscape.svn.sourceforge.net/svnroot/inkscape/inkscape/trunk"
...
src_unpack() {
	...
	eautoreconf
	gnome2_omf_fix
	glib-gettextize --copy --force || die "gettextsize failed."
