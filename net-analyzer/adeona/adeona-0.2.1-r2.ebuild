...
pkg_postinst(){
	echo
	elog "If this is your first install of adeona it needs to be"
	elog "initialised.  Run the following command:"
	echo
	elog "emerge --config =${P}"
	echo
	elog "Existing users need only restart the adeona service."
	echo
}
