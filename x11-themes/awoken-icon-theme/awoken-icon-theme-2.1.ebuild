...
SRC_URI="http://www.deviantart.com/download/163570862/${MY_PN}_by_alecive-d2pdw32.zip"
...
src_install() {
	...
	dobin AwOkenDark/awoken-icon-theme-customization-dark
